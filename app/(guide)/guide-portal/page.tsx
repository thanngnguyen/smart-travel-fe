...
export default function GuidePortalPage() {
  const [filter, setFilter] = useState<"Tất cả" | "Chờ xử lý">("Tất cả");
      ...
      <main className="flex-grow p-6 space-y-8 max-w-lg mx-auto w-full">
        ...
        <section>
          <div className="flex justify-between items-end mb-4">
            <h2 className="text-2xl font-bold">Lịch trong ngày</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.04)] border-l-4 border-primary hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-shadow">
              ...
              <h3 className="text-lg font-bold leading-tight mb-1">
                Khám phá thung lũng Alpine
              </h3>
              <p className="text-sm text-on-surface-variant mb-4">
                Điểm đón: Ga Trung Tâm phía Đông
              </p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex -space-x-2">
                  ...
                  />
                  <div className="w-8 h-8 rounded-full bg-surface-container-highest border-2 border-white flex items-center justify-center text-[10px] font-bold text-on-surface-variant">
                    +12
                  </div>
                </div>
                <span className="text-xs font-bold text-primary bg-primary/10 px-2 py-1 rounded-md">
                  15 / 20 chỗ đã lấp đầy
                </span>
              </div>
            </div>
            ...
            <div className="bg-surface-container-low rounded-2xl p-5 border border-outline-variant/30 hover:bg-surface-container transition-colors cursor-pointer">
              ...
              <h3 className="text-lg font-bold leading-tight mb-1 text-on-surface/80">
                Trekking vườn nho hoàng hôn
              </h3>
              <p className="text-sm text-on-surface-variant mb-4">
                Điểm đón: Plaza del Sol
              </p>
              <div className="flex items-center justify-between opacity-60">
                <div className="flex items-center gap-2">
                  <Icon name="group" className="text-sm" />
                  <span className="text-xs font-bold">Đã đặt 8</span>
                </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="bg-surface-container-high rounded-lg p-1 flex">
              <button
                ...
                className={`px-4 py-1.5 rounded-md text-xs font-bold transition-all ${filter === "Tất cả" ? "bg-white shadow-sm text-on-surface" : "text-on-surface-variant hover:bg-white/50"}`}
              >
                Tất cả
              </button>
              <button
                onClick={() => setFilter("Chờ xử lý")}
                className={`px-4 py-1.5 rounded-md text-xs font-bold transition-all ${filter === "Chờ xử lý" ? "bg-white shadow-sm text-on-surface" : "text-on-surface-variant hover:bg-white/50"}`}
              >
                Chờ xử lý
              </button>
            </div>
          ...
          <div className="relative">
            <Icon
              name="search"
              className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant focus-within:text-primary transition-colors"
            />
            <input
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-on-surface-variant font-medium">
                    Cổng 4 • <span className="text-primary">2 người lớn</span>
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-4">
                <span className="text-xs font-bold text-primary uppercase tracking-wider flex flex-col items-center">
                  <Icon
                    name="check_circle"
                    filled
                    className="text-primary text-xl mb-0.5"
                  />
                  Xong
                </span>
              </div>
